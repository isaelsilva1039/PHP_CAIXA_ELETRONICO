...
include_once 'model/Class.contas.php';
...
<html lang="pt-br">
    ...
    <body>
    	<tbody>
							<?php foreach($contas->usuarioLogado($id) AS $conta):?>
								<tr class="tr">
        ...
        <div class="d-flex">
            ...
            <nav class="sidebar">
                <ul class="list-unstyled">
                    ...
                    <li><a href=""><i class="fas fa-user"></i> Relatorio  </a></li>
               
                    <li><a href=""><i class="fas fa-paste"></i> Cadastros</a></li>

                    <li><a href=""><i class="fas fa-dolly"></i>Dashborde</a></li>

                    <li><a href=""><i class="fas fa-handshake"></i>Perfil</a></li>
            ...
            <div class="content p-1">
                <div class="list-group-item" style="background-color: #eaeef3">
                        ...
                        <div class="mr-auto p-2">
                            <h2 class="text-center"> Caixa Laches <i class="fa fa-money-check-alt"></i></h2><br><br>
                        </div>
                        ...
                        <div class="table-responsive">
							<table class="table table-hover">
								...
								<tbody>
									<?php foreach($contas->listaContas() AS $conta):?>
									<tr class="tr">
						...
						<form method="POST" action="view/transacoes.php">
							...
							<button class="btn btn-warning btn-xs" style="background: red">
...
<?php
	...
	header("location: login.php?define_location");
}
