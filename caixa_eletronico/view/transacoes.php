...
<div class="content p-1">
                <div class="list-group-item" style="background-color: #eaeef3">
                        ...
                        <div class="mr-auto p-2">
                            <h2 class="text-center"> Banco I.D <i class="fa fa-money-check-alt"></i></h2><br>
                        </div>
                        ...
                        <div class="table-responsive">
							<table class="table table-hover">
								...
								<tbody>
									<?php foreach($contas->getInfo($id) as $conta):?>
									<tr class="tr">
							...
							<form method="POST" action="../controller/controleMovimentacao.php" style="font-weight: bold; font-style: italic;" class="formulario">
							...
							<div class="table-responsive">
								...
								<table class="table table-hover">
									...
									<?php foreach($contas->historicoDeTransacao($id) as $conta):
									 ?>
									...
									<tbody style="text-align: center;">
										...
										<tr>
											<td>
											 	<?php echo date("d/m/Y H:m:s", strtotime($conta['data_operacao'])) ?> 
											</td>
											
											
											<?php 

											if($conta['tipo'] == "Deposito"): ?>
											

											<td style="color: green;">
												R$ <?php echo $conta['valor'] ?>	
											</td>
